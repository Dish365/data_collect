...
def main():
    ...
    if files_changed > 0:
        ...
        print(f"  • mode: 'outlined' → mode: 'outlined'")
        print(f"  • mode: "outlined" → mode: \"outlined\"")
